 ...
 *
 */
define(['ibTaoEmbedded/runtime/js/jquery_2_1_1_amd', 'OAT/util/html'], function($, html){
    'use strict';
    ...
    function refreshSrc(id, $container, config, assetManager){
        if(typeof config.item  == "string" && typeof config.task  == "string"){
            ...
            let _url = assetManager.resolve('ibTaoEmbedded/runtime/assets/CBA/src/pages/emulatorPage.html')+"?itemName="+config.item+"&taskName="+config.task;
